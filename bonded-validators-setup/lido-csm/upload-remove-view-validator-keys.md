...
* On the CSM Widget, upload your `deposit data file` and select the corresponding bond type (ETH, stETH, wstETH) & bond amount to provide. The following information will be displayed:
